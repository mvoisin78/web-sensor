...
X = np.array([[0,1.1],[1.1,1],[1,0.1],[1,1.1],[0,0],[2,0],[1,3],[0,4],[0,0.9],[0,1],
              [1,-0.1],[1.1,0],[1,0.9],[0.1,1],[0.8,0.9],[1,0],[0.9,1],[-0.1,0.95],[1.1,1.1],[1,0],[1,1]])
clusterer = DenStream(lambd=0.01, eps=0.3, beta=0.5, mu=3)
for row in X:
